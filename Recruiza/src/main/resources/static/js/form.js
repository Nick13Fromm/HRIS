...
function generateLogoutForm() {
    ...
    modal.innerHTML = `
        <div class="modalBox">
            ...
            <p>Это действие приведет к выходу с этого сайта</p>
            <div class="modalButtonBox">
                <a href="/logout">Да <ion-icon name="sad-outline"></ion-icon></a>
                <a onclick="closeLogoutForm()">Нет <ion-icon name="happy-outline"></ion-icon></a>
            </div>
        </div>
